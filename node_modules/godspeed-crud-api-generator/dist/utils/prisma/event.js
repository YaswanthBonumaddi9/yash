...
const generateEventKey = ({ dataSourceName, modelName, modelFields }, method) => {
    ...
    switch (method) {
        case 'one':
            return `/${dataSourceName.toLowerCase()}/${modelName.toLowerCase()}/:${indexField === null || indexField === void 0 ? void 0 : indexField.name}.http.get`;
        case 'create':
            return `/${dataSourceName.toLowerCase()}/${modelName.toLowerCase()}.http.post`;
        case 'update':
            return `/${dataSourceName.toLowerCase()}/${modelName.toLowerCase()}/:${indexField === null || indexField === void 0 ? void 0 : indexField.name}.http.put`;
        case 'delete':
            return `/${dataSourceName.toLowerCase()}/${modelName.toLowerCase()}/:${indexField === null || indexField === void 0 ? void 0 : indexField.name}.http.delete`;
        case 'search':
