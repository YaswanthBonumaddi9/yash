...
class GSFunction extends Function {
    ...
    _executefn(ctx, taskValue) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let status; //Final status to return
            let args = this.args;
            try {
                ...
                if (args === null || args === void 0 ? void 0 : args.datasource) {
                    // If datasource is a script then evaluate it else load ctx.datasources as it is.
                    const datasource = ctx.datasources[args.datasource];
                    if (datasource instanceof Function) {
                        args.datasource = yield (0, scriptRuntime_1.default)(ctx, datasource, taskValue);
                    ...
                    if (ds.before_method_hook) {
                        yield ds.before_method_hook(ctx);
                    }
                }
                ...
                if (Array.isArray(args)) {
                    ...
                    res = yield this.fn(...[ctx, ...Object.values(args)]);
                }
            ...
            if ((_a = args.datasource) === null || _a === void 0 ? void 0 : _a.after_method_hook) {
                ctx.outputs.current_output = status;
                yield args.datasource.after_method_hook(ctx);
            }
            return status;
        });
    }
            ...
            try {
                ...
                if (this.yaml.authz) {
                    ...
                    if (allow.success) {
                        ...
                        else if ((0, utils_1.isPlainObject)(allow.data)) {
