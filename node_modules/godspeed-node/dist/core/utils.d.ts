...
export declare const PROJECT_ROOT_DIRECTORY: string;
...
export declare function checkDatasource(workflowJson: PlainObject, datasources: PlainObject): GSStatus;
export declare function prepareScript(str: string): Function;
export declare function compileScript(args: any): Function;
