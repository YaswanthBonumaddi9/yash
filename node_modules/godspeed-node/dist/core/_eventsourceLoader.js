...
function default_1(eventsourcesFolderPath, datasources) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        var _d;
        logger_1.logger.info('eventsourcesFolderPath %s', eventsourcesFolderPath);
            ...
            for (var _e = true, _f = __asyncValues(Object.keys(eventsourcesConfigs)), _g; _g = yield _f.next(), _a = _g.done, !_a;) {
                ...
                try {
                    ...
                    if (!correspondingDatasource) {
                        ...
                        yield (_d = path_1.default.join(eventsourcesFolderPath, 'types', eventSourceType), Promise.resolve().then(() => __importStar(require(_d)))).catch((err) => {
                            logger_1.logger.error(`Error in importing the event source type ${eventSourceType} for eventsource ${esName}. Error message ${err.message}`);
                            throw err;
                        })
                            .then((Module) => __awaiter(this, void 0, void 0, function* () {
                            //@ts-ignore
                            const eventSourceInstance = new Module.default(config_1.default, correspondingDatasource); // eslint-disable-line
