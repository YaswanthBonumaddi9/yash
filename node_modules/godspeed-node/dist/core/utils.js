...
exports.removeNulls = exports.checkFunctionExists = exports.compileScript = exports.prepareScript = exports.checkDatasource = exports.setAtPath = exports.getAtPath = exports.isPlainObject = exports.PROJECT_ROOT_DIRECTORY = void 0;
...
//@ts-ignore
exports.PROJECT_ROOT_DIRECTORY = (0, path_1.dirname)(require.main.filename);
...
function checkDatasource(workflowJson, datasources) {
    logger_1.logger.debug('checkDatasource');
    logger_1.logger.debug('workflowJson: %o', workflowJson);
    for (let task of workflowJson.tasks) {
        if (task.tasks) {
            logger_1.logger.debug('checking nested tasks');
