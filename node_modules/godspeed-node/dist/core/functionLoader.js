...
exports.loadFunctions = exports.createGSFunction = void 0;
...
function loadFunctions(datasources, pathString) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let loadFnStatus;
        logger_1.logger.info('functions %s', Object.keys(functions));
        ...
        logger_1.logger.info('Loaded native functions: %s', Object.keys(code));
        ...
        logger_1.logger.info('Creating workflows: %s', Object.keys(functions));
        for (let f in functions) {
