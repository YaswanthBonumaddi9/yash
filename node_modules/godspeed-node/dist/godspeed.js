...
const definitionsLoader_1 = require("./core/definitionsLoader");
const _datasourceLoader_1 = __importDefault(require("./core/_datasourceLoader"));
const _eventsourceLoader_1 = __importDefault(require("./core/_eventsourceLoader"));
const functionLoader_1 = require("./core/functionLoader");
...
class Godspeed {
    ...
    _loadEvents() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.logger.info('Events %o', events);
    ...
    _loadDefinitions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const definitions = yield (0, definitionsLoader_1.loadAndRegisterDefinitions)(this.folderPaths.definitions);
            logger_1.logger.info('Definitions %o', definitions);
    ...
    _loadFunctions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loadFnStatus = yield (0, functionLoader_1.loadFunctions)(this.datasources, this.folderPaths.workflows);
            logger_1.logger.info('Functions %o', Object.keys(loadFnStatus.functions));
    ...
    _loadDatasources() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let datasources = yield (0, _datasourceLoader_1.default)(this.folderPaths.datasources);
            logger_1.logger.info('Datasources %o', datasources);
    ...
    _loadEventsources() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let eventsources = yield (0, _eventsourceLoader_1.default)(this.folderPaths.eventsources, this.datasources);
            logger_1.logger.info('Eventsources %o', eventsources);
