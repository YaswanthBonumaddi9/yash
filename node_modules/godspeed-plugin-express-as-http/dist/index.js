...
exports.ExpressEventSource = exports.ExpressDataSource = void 0;
const godspeed_node_1 = require("godspeed-node");
const express_1 = __importDefault(require("express"));
const body_parser_1 = __importDefault(require("body-parser"));
const lodash_1 = __importDefault(require("lodash"));
class ExpressDataSource extends godspeed_node_1.GSDataSource {
    initClient() {
...
exports.ExpressDataSource = ExpressDataSource;
class ExpressEventSource extends godspeed_node_1.GSEventSource {
    subscribeToEvent(eventRoute, eventConfig, processEvent) {
        ...
        const app = this.datasource.client;
        //@ts-ignore
        app[httpMethod](endpoint, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const gsEvent = ExpressEventSource.createGSEvent(req, endpoint);
    ...
    static createGSEvent(req, endpoint) {
        ...
        const event = new godspeed_node_1.GSCloudEvent('id', endpoint, new Date(), 'http', '1.0', data, 'REST', new godspeed_node_1.GSActor('user'), {});
        return event;
    }
}
exports.ExpressEventSource = ExpressEventSource;
